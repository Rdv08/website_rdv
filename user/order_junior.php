<?php set_include_path("C:/Program Files (x86)/xampp/htdocs/futsal/user/"); ?>
<?php
include 'cekuser.php';
?>
<!DOCTYPE html>
...
<div class="about">
	...
	<div class="wthree_head_section">
		...
		<div class="ab-agile">
	        ...
	        <label>Harga</label>
	        <input type="text" class="form-control" name="harga" aria-describedby="basic-addon1" value="100.000" readonly="readonly" id="harga"><br>
	        <label>Tanggal</label>
            ...
            <select name="rek_admin" class="selectpicker form-control" data-live-search="true">
	            	...
	            	<option value="MANDIRI 1570006890744">MANDIRI 1570006890744</option>
	                <?php 
	                include "../koneksi/koneksi.php";
