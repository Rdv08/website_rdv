			...
			<div class="map-home">
				<div class="col-md-4 drop-pad sign-gd-two">
					...
					<ul>
						...
						<li><i class="glyphicon glyphicon-earphone" aria-hidden="true"></i> 0821 1650 4457</li>
						<li><i class="glyphicon glyphicon-envelope" aria-hidden="true"></i><a href="mailto:radivaangga@gmail.com"> radivaangga@gmail.com</a></li>
					</ul>
